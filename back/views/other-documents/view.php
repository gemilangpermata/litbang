...
$this->title = 'Lihat Dokumen';
$this->params['header'] = 'Lihat Dokumen';
$this->params['breadcrumbs'][] = 'Dokumen';
$this->params['breadcrumbs'][] = 'Lainnya';
$this->params['breadcrumbs'][] = 'Lihat';
    ...
    <div class="col col-md-6">
        <div class="card card-default">
            ...
            <div class="card-body">
                <?= $form
                    ->field($model, 'no')
                    ->textInput(['placeholder' => 'Nomor Dokumen', 'maxlength' => true, 'disabled' => true])
                ?>

                <?= $form
                    ->field($model, 'name')
                    ->textInput(['placeholder' => 'Nama Dokumen', 'maxlength' => true, 'disabled' => true])
                ?>
                ...
                <?= $form->field($model, 'area')->widget(Select2::class, [
                    ...
                    'data' => $areas,
                    'options' => ['placeholder' => 'Pilih daerah', 'disabled' => 'true'],
                    'pluginOptions' => [
                        'allowClear' => true,
                ...
                <?= $form->field($model, 'category')->widget(Select2::class, [
                    ...
                    'theme' => Select2::THEME_KRAJEE_BS4,
                    'data' => $categories,
                    'options' => ['placeholder' => 'Pilih kategori', 'disabled' => 'true'],
                    'pluginOptions' => [
                        'allowClear' => true,
                        'minimumInputLength' => 3,
                        'language' => [
                ...
                <?= $form
                    ...
                    ->widget(Select2::class, [
                        ...
                        'options' => ['placeholder' => 'Pilih tahun', 'disabled' => true],
                        'pluginOptions' => [
                            'allowClear' => true,
                        ],
                    ])
                ...
                <?= $form
                    ->field($model, 'pic')
                    ->textInput(['placeholder' => 'Penanggungjawab', 'maxlength' => true, 'disabled' => true])
                ?>
            ...
            if ($status === Yii::$app->params['DOC_STATUS_DRAFT'] && ($isValidator || $isAdministrator) && $model->created_by !== $user->id) {
                ...
                $statusOptions = [
                    Yii::$app->params['DOC_STATUS_APPROVED'] => 'Unpublished',
                ];
            } else {
                $statusOptions = [];
            }
            ...
            <div class="card-footer text-right">
                <div class="form-inline justify-content-end">
                    ...
                    <?= Html::submitButton('Submit', ['class' => 'ml-2 btn btn-primary']) ?>
                </div>
            </div>
            <?php
            }
