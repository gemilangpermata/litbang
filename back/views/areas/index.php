...
$this->title = 'Daerah';
$this->params['header'] = 'Daerah';
$this->params['breadcrumbs'][] = 'Daerah';

$this->registerJsFile(
    '@web/js/areas/index.js?v=' . date('YmdHis'),
    [
        'depends' => [
        ...
        <div class="card-tools">
            ...
            <div class="input-group input-group-sm">
                <select name="type" class="custom-select">
                    <option value="">Semua jenis daerah</option>
                    <option value="district" <?= $type === 'district' ? 'selected' : '' ?>>Kecamatan</option>
                    <option value="sub-district" <?= $type === 'sub-district' ? 'selected' : '' ?>>Kelurahan</option>
                </select>
                <input type="text" name="keyword" class="form-control" value="<?= $keyword ?>" placeholder="Cari Daerah">
    ...
    <div class="card-body p-0">
        ...
        $columns = [
            ...
            [
                ...
                'value' => function ($model) {
                    return '
                        <span class="badge badge-pill badge-'. (empty($model->parent) ? 'info' : 'warning') .'">
                            '. (empty($model->parent) ? 'Kecamatan' : 'Kelurahan') .'
                        </span>
                    ';
                }
            ],
