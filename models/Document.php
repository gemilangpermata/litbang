...
class Document extends ActiveRecord
{
    ...
    public function getFileUrl() {
        ...
        return Yii::$app->params['DOCUMENTS_URL'] . $basename . ' - ' . $this->id . '.' . $ext;
    }
    ...
    public function uploadFile()
    {
        ...
        $this->file = UploadedFile::getInstance($this, 'file');
        if (empty($this->file)) {
            $this->addError('file', 'Kamu harus lampirkan sebuah file.');
            return false;
        }
        ...
        if (!$this->file->saveAs($path)) {
            $this->addError('file', 'Terjadi masalah saat mengupload file, silahkan hubungi administrator.');
            return false;
        }
